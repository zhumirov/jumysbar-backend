...
public class GmailQuickstart {
    ...
    public static String email() throws IOException, GeneralSecurityException {
// Build a new authorized API client service.
        ...
        for (int i = 0; i < Math.min(messages.size(), 10); i++) {
            str += service.users().messages().get(user, messages.get(i).getId()).execute().getPayload().getParts();
